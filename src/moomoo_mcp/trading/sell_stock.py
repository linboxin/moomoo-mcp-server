...
def sell_stock(symbol: str, quantity: int, price: float = 0.0, order_type: str = "LIMIT") -> Dict[str, Any]:
    """
    Place a SELL order.
    ...
    return client.place_order(symbol, quantity, price, TrdSide.SELL, order_type=trd_order_type)
